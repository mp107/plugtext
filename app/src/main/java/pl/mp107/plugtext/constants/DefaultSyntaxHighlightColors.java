...
public abstract class DefaultSyntaxHighlightColors {
    ...
    public static final int editor_normal_text_color = Color.parseColor("#000000");
    public static final int editor_numbers_color = Color.parseColor("#7ba212");
    public static final int editor_preprocessors_color = Color.parseColor("#00ff00");
}
